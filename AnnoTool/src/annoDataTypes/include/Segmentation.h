...
//		class SegmentAttribute : AnnoAttribute
//		{
...
//			public:
//				SegmentAttribute(Segmentation* parAnno = NULL);
//				SegmentAttribute(Segmentation* parAnno, const QString& name, const QString& className,
//						const QString& value);
//				SegmentAttribute(const QString& name, const QString& className,
//						const QString& value);
//				~SegmentAttribute();
//
