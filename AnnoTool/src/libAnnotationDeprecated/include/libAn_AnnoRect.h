...
namespace libAn {
    ...
    struct compAnnoPointById {
        bool operator()(const AnnoPoint &p1, const AnnoPoint &p2) {
            return p1.id < p2.id;
        }
    };
    ...
    class AnnoRect {
        ...
        public:
            ...
            void addAnnoPoint(AnnoPoint ap) {
                m_vAnnoPoints.push_back(ap);
            };
            void clearAnnoPoints() {
                m_vAnnoPoints.clear();
            };

            std::vector<AnnoPoint> &getAnnoPoints() {
                return m_vAnnoPoints;
            };
            const std::vector<AnnoPoint> &getAnnoPoints() const {
                return m_vAnnoPoints;
            };
