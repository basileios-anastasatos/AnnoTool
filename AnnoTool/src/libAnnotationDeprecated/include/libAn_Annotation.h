...
namespace libAn {
    ...
    class Annotation {
        public:
            ...
            Annotation(const std::string &name): m_nImageWidth(0), m_nImageHeight(0), m_bIsTiffStream(false)  {
                m_sName = name;
            };
        ...
        public:
            ...
            void setImageHeight(int nImageHeight) {
            ...
            const AnnoRect &annoRect(unsigned i) const {
                return m_vRects[i];
            };
            AnnoRect &annoRect(unsigned i) {
                return m_vRects[i];
            };

            const AnnoRect &operator[]  (unsigned i) const {
                return m_vRects[i];
            };
            AnnoRect &operator[] (unsigned i) {
                return m_vRects[i];
            };

            void addAnnoRect(const AnnoRect &rect) {
                m_vRects.push_back(rect);
            };
            void removeAnnoRect(unsigned pos) {
                m_vRects.erase(m_vRects.begin() + pos);
            };
            ...
            const std::string &imageDim() const {
                return m_sDim;
            };
            ...
            //Stream extensions
            const int frameNr() const {
                return m_dFrameNr;
            }
            void setFrameNr(const int frameNr) {
                m_dFrameNr = frameNr;
                m_bIsTiffStream = true;
            }
            const bool isStream() const {
                return m_bIsTiffStream;
            }
