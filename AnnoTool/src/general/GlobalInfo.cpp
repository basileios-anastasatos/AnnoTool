...
//#else
//#error "Debug/Release configuration is invalid!"
#endif
...
const quint16 GlobalInfo::appVersionMinor		= 14;
...
const QString GlobalInfo::appBuildInfo("Experimental Testing Build for Filtering, Coloring and Copy/Paste Operations");
